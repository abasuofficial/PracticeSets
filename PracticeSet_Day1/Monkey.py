...
n = int(input("Enter the total number of monekeys"))
...
for a in range(0,n,2):
    ...
    if m < k:
        ...
        MonekyFedBanana = MonekyFedBanana+1
...
for b in range(1,n,2):
    ...
    if p < j:
        ...
        MonkeyFedPeanut = MonkeyFedPeanut+1

if m+p < j:
    MonekyFedBanana = MonekyFedBanana+1

print("Number of  Monkeys left on the tree ",(MonekyFedBanana+MonkeyFedPeanut))